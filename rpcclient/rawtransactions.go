...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, maxFeeRate int) FutureSendRawTransactionResult {
	txHex := ""
	if tx != nil {
...
func (c *Client) SendRawTransaction(tx *wire.MsgTx, maxFeeRate int) (*chainhash.Hash, error) {
